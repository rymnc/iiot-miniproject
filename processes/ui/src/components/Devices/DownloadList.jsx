...
const DownloadList = ({ headings, where }) => {
    ...
    const downloadHandler = async (e) => {
        ...
        try {
            ...
            const { data } = await apiClient.post('/devices/some', payload, { responseType: "blob" })
    ...
    return (
        <>
            <p className="mt-2 mb-0"> You can also download a list of all your devices</p>
            <Button variant="outline-info" onClick={downloadHandler}>Download</Button>
